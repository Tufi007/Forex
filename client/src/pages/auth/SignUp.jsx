    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-textMuted">Start your trading journey</p>
        </div>
        ...
        <Card>
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex items-start">
              <input
                type="checkbox"
                className="h-4 w-4 text-primary focus:ring-primary border-border rounded bg-surface mt-1"
              ...
              <div className="ml-3">
                <label className="text-sm text-textSecondary">
                  I agree to the{' '}
                  <Link to="/terms" className="text-primary hover:text-primaryHover">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link to="/privacy" className="text-primary hover:text-primaryHover">
                    Privacy Policy
                  </Link>
                </label>
                {errors.acceptTerms && (
